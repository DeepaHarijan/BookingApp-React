      ...
      <Header type="list"/>
        ...
        <div className='hotelContainer'>
          ...
          <div className='hotelWrapper'>
            ...
            <span className='hotelPriceHighLight'>Book a stay over ₹3800 at this property and get a free airport taxi </span>
            ...
            <div className='hotelDetails'>
              <div className='hotelDetailsText'>
                <h1 className='hotelTitle'>Stay in the heart of Krakw</h1>
